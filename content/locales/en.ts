...
export const en: Dictionary = {
  ...
  projects: {
    ...
    awardSub: "ElGhella & AItraid — awarded by Algeria's innovation programme",
    ...
    items: {
      ...
      aitraid: { tag: 'Marketplace', desc: 'B2B, B2C, and freelancer marketplace connecting buyers and sellers across Algeria.' },
