...
export const fr: Dictionary = {
  ...
  projects: {
    ...
    awardSub: "ElGhella & AItridi — distingués par le programme d'innovation algérien",
    ...
    items: {
      ...
      aitraid: { tag: 'Marketplace IA', desc: "Marketplace pour acheter, vendre et échanger des agents IA autonomes, avec transactions, avis et tableaux de bord vendeurs intégrés." },
      aitridi: { tag: 'Marketplace', desc: "Marketplace B2B, B2C et freelance reliant acheteurs et vendeurs à travers l'Algérie." },
