    ...
    <div className="relative isolate min-h-screen bg-white/90">
      ...
      <section className="mx-auto max-w-3xl px-4 py-24 sm:px-6 lg:px-8">
        <div className="rounded-3xl border border-neutral-200 bg-white/95 p-8 shadow-lg sm:p-12">
          ...
          {/* Test Mode Warning */}
          <div className="mb-8 rounded-2xl border-2 border-amber-400 bg-amber-50 p-6 shadow-sm">
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                <h3 className="text-base font-semibold text-amber-900">
                  Mode Test - Paiement non configure
                </h3>
                <p className="mt-2 text-sm text-amber-800">
                  Cette page de paiement est actuellement en mode test. Le systeme de paiement 
                  n&apos;est pas encore entierement configure. Aucune transaction reelle ne sera 
                  effectuee pour le moment.
                </p>
                <p className="mt-2 text-sm text-amber-800 font-medium">
                  Veuillez nous contacter directement pour finaliser votre commande.
                </p>
              </div>
            </div>
          </div>
