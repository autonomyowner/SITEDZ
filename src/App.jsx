...
const STEPS = [
  {
    ...
    desc: 'We discuss your space, vision, and the story you want the piece to tell.',
  },
  {
    num: '02',
    title: 'Wood Selection',
    desc: 'We hand-select boards for grain character and suitability to your design.',
  },
  {
    num: '03',
    title: 'Carving & Engraving',
    desc: 'Precision laser engraving combined with hand-finishing brings the pattern to life.',
  },
  {
    num: '04',
    title: 'LED Integration',
    desc: 'Custom-wired LED system is built in — warm white, colour-changing, or smart-controlled.',
  },
]
    ...
    <section className="featured-wrap">
      <div className="featured__card">
        ...
        <div className="featured__image-wrap">
          <img
            src="/products/p4.jpg"
            alt="Hand-carved illuminated wood panel — Terrain Canvas"
      ...
      <div className="gallery__grid">
        {GALLERY.map((item, i) => (
          ...
          >
            <img
              src={item.src}
              alt={`Origawood illuminated wood art panel ${i + 1}`}
    ...
    <section className="commission" id="commission">
      <div className="commission__inner">
        ...
        <p className="commission__sub">
          ...
          size, style, light colour, meaning — and we will bring it
          to life in wood.
        </p>
